        ...
        <AlertDialogContent>
          <AlertDialogHeader className="items-center">
            ...
            <AlertDialogDescription className="text-center">
              Thank you for submitting a support request. We will respond
              shortly to your provided email address.
            </AlertDialogDescription>
          </AlertDialogHeader>
    ...
    <>
      ...
      <div className="flex flex-col gap-5 md:flex-row md:gap-0 md:divide-x">
        <div className="basis-3/4 px-5">
          <h1 className="font-display text-3xl mb-5">Support</h1>
          <Form {...form}>
