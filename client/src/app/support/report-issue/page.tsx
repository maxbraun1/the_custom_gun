...
export default function ReportAnIssue() {
  ...
  const onSubmit = async (values: z.infer<typeof FormSchema>) => {
    ...
    await axios
      .post(
        process.env.NEXT_PUBLIC_API_URL + "/support/issue",
      ...
      .catch((error) => {
        ...
        toast({
          variant: "destructive",
          title:
            "An error occured while submitting issue report. Please try again later.",
        });
      });
  };
        ...
        <AlertDialogContent>
          <AlertDialogHeader className="items-center">
            ...
            <AlertDialogDescription className="text-center">
              Thank you for submitting a issue report. We are always looking for
              ways to improve The Custom Gun, and we appreciate your input.
            </AlertDialogDescription>
          </AlertDialogHeader>
    ...
    <>
      ...
      <div className="flex flex-col gap-5 md:flex-row md:gap-0 md:divide-x">
        <div className="basis-3/4 px-5">
          <h1 className="font-display text-3xl mb-3">Report an Issue</h1>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              ...
              <Button
                ...
                type="submit"
              >
                {loading ? <Spinner size={25} /> : "Report"}
              </Button>
            </form>
          </Form>
        </div>
